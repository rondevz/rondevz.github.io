...
export default function ArticleCard({ article, index }: { article: ArticleProps; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-pink-500 to-violet-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
