  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Description */}
        <p className="text-sm text-gray-400 line-clamp-3 mb-6 grow leading-relaxed">
          {project.description}
        </p>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {project.techStack.map((tech) => (
            <span key={tech} className="px-2 py-1 text-[10px] uppercase tracking-wider font-bold rounded bg-gray-800 text-gray-300 border border-gray-700 group-hover:border-pink-500/30 transition-colors">
              {tech}
            </span>
          ))}
        </div>
        ...
        <div className="flex gap-4 mt-auto">
          {project.link && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-sm font-medium text-gray-500 hover:text-pink-400 transition-colors"
            >
          ...
          {project.github && (
            <div
              className="flex items-center text-sm font-medium text-gray-500 group-hover:text-white transition-colors"
            >
